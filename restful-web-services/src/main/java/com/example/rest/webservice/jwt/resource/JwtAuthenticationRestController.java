...
import com.example.rest.webservice.jwt.JwtTokenUtil;
...
public class JwtAuthenticationRestController {
	...
	@RequestMapping(value = "${jwt.get.token.uri}", method = RequestMethod.POST) //Getting for application .prop files
